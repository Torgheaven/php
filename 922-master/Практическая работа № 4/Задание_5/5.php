...
<table border="1">
    <tr>
		...
		<th>Дата выпуска</th>
        <th>Страна</th>
        <th>Индитификатор группы</th>
    </tr>
    <?php foreach ($album as $albums): ?>
        <tr>
            <td><?php echo $albums['id_album']; ?></td>
            <td><?php echo $albums['title']; ?></td>
			<td><?php echo $albums['date']; ?></td>
            <td><?php echo $albums['country']; ?></td>
            <td><?php echo $albums['id_team']; ?></td>
        </tr>
    <?php endforeach; ?>
</body>
</html>