...
<table border="1">
    ...
    <?php foreach ($discography as $discographys): ?>
        <tr>
            <td><?php print_r ($discographys['id'][0]); ?></td>
            <td><?php print_r ($discographys['name'][0]); ?></td>
			<td><?php print_r ($discographys['date'][0]); ?></td>
            <td><?php print_r ($discographys['label'][0]); ?></td>
			<td><?php print_r ($discographys['format'][0]); ?></td>
            <td><?php print_r ($discographys['status'][0]); ?></td>
        </tr>
    <?php endforeach; ?>
</table>
</body>
